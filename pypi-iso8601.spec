...
Source0  : https://files.pythonhosted.org/packages/27/23/97cd1cb5792ece594ec5cf16cc4921f91838c689c82c8078ee442751f8dc/iso8601-2.0.0.tar.gz
...
%prep
%setup -q -n iso8601-2.0.0
cd %{_builddir}/iso8601-2.0.0
pushd ..
cp -a iso8601-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686326711
